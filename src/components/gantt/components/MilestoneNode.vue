  ...
  <div class="milestone-node">
    ...
    >
      ...
      <template #reference>
        <div class="node-content" :style="nodeStyle">
          ...
          />
          <span v-if="showIndex" class="node-index">{{ index }}</span>
    ...
    >
      <template #footer>
        ...
        <el-button type="primary" size="mini" @click="handleDelConfirm">
          确定
        </el-button>
      </template>
    </BaseDialog>
...
const milestone = ref({
  ...
  planEndDate: '',
  realEndDate: '',
  status: MILESTONE_STATE.NOT_STARTED
})
